...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "CRYPTOPP_8_9_0"
  WORKING_DIRECTORY "X:/CLionProjects/PasswordManagement/cmake-build-debug/lib/cryptopp-cmake/cryptopp"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "CRYPTOPP_8_9_0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("CRYPTOPP_8_9_0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/CRYPTOPP_8_9_0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'X:/CLionProjects/PasswordManagement/cmake-build-debug/lib/cryptopp-cmake/cryptopp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'X:/CLionProjects/PasswordManagement/cmake-build-debug/lib/cryptopp-cmake/cryptopp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
